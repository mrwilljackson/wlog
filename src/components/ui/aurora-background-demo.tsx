  ...
  return (
    <AuroraBackground>
      ...
      >
        ...
        <div className="font-extralight text-base md:text-4xl dark:text-neutral-200 py-4 justify-center">
        ...
        <div className="mt-8 flex flex-col md:flex-row gap-6 justify-center">
          <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg max-w-xs">
            ...
            <p className="text-sm opacity-80">Connect with me here, find our what I do and what I've done in the past.</p>
          </div>
          <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg max-w-xs">
